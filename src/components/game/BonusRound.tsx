...
export function BonusRound({ 
  ...
  // Mobile: 4 rows × 4 columns = 16 cards (matches SD layout)
  ...
  // Desktop: always 6 columns (max 3 rows), Mobile: 4 columns (matches SD)
  const gridCols = isMobile ? 4 : 6;
  // Card size: sdm on mobile (matches SD), sd on desktop
