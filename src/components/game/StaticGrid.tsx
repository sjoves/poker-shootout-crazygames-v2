...
export function StaticGrid({ deck, selectedCardIds, onSelectCard }: StaticGridProps) {
  ...
  const maxVisibleCards = isMobile ? 25 : 24; // 5x5 on mobile, 6x4 on desktop
  ...
  return (
    <div className="absolute inset-0 flex items-start justify-center px-2 sm:px-4 md:px-6 lg:px-8 pt-[8.75rem]">
      <div
