          ...
          <AnimatePresence>
            {visibleHand && (
              ...
              >
                ...
                >
                  <div className="text-lg sm:text-2xl md:text-xs font-bold text-primary-foreground tracking-wide uppercase drop-shadow-lg">
                  ...
                  <motion.div 
                    ...
                    className="text-2xl sm:text-4xl md:text-sm font-bold text-black drop-shadow-lg"
                  >
