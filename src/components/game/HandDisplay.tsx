...
export function HandDisplay({ cards, maxCards = 5, currentHand, className }: HandDisplayProps) {
  ...
  return (
    <div className={cn('relative flex flex-col items-center gap-2 sm:gap-3', className)}>
      <div className="relative bg-card/90 backdrop-blur-sm rounded-2xl px-4 py-4 sm:px-6 sm:py-5 border-2 border-primary/40">
        ...
        <AnimatePresence>
          {visibleHand && (
            <motion.div
              ...
              className="absolute inset-0 flex items-center justify-center z-20 rounded-2xl overflow-hidden bg-gradient-to-br from-primary/95 via-primary/90 to-primary/95 shadow-[0_0_40px_hsl(var(--primary)/0.5)]"
            >
              <motion.div
