...
const SIZE_CONFIG = {
  ...
  // Smaller hand display for desktop (scaled down ~20%, font scaled 15% smaller)
  'hand-sm': { card: 'w-[calc(8.8vh*0.714)] h-[8.8vh]', rank: 'text-[0.85rem] font-black', corner: 'text-[0.65rem]', center: 'text-xs', pip: 'text-[7px]', gap: 'gap-0' },
